        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              <span className="flex-shrink-0 w-10 h-10 gradient-bg text-white rounded-full flex items-center justify-center font-bold mr-4">1</span>
              <div>
            ...
            <div className="flex items-start">
              <span className="flex-shrink-0 w-10 h-10 gradient-bg text-white rounded-full flex items-center justify-center font-bold mr-4">2</span>
              <div>
            ...
            <div className="flex items-start">
              <span className="flex-shrink-0 w-10 h-10 gradient-bg text-white rounded-full flex items-center justify-center font-bold mr-4">3</span>
              <div>
            ...
            <div className="flex items-start">
              <span className="flex-shrink-0 w-10 h-10 gradient-bg text-white rounded-full flex items-center justify-center font-bold mr-4">4</span>
              <div>
