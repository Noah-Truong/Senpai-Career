  ...
  const getNavItems = () => {
    ...
    if (userRole === "corporate_ob") {
      return [
        ...
        {
          href: "/student-list",
          label: t("nav.studentList") || "Student List",
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ boxShadow: "2px 0 8px #0000000D" }}
      >
        ...
        <div className={`px-3 py-3 border-b border-gray-200`}>
          ...
          <div className={`relative ${isCollapsed && !isMobile ? "flex justify-center" : ""}`}>
            <Link 
              href="/messages" 
              className={`${getLinkClasses('/messages')} hover:bg-[#F0FFF8] ${isCollapsed && !isMobile ? "justify-center" : ""}`}
